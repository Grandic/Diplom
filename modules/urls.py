...
from modules.views import ModuleCreateAPIView, ModuleListAPIView, ModuleRetrieveAPIView, ModuleUpdateAPIView, ModuleDestroyAPIView
...
urlpatterns = [
    ...
    path('modules//<int:pk>/', ModuleDestroyAPIView.as_view(), name='module-destroy'),
